...
void loop() {
  update_gps_data();
  gsm_http_post(F("api_token=GM61w8fLm3N7dXF8MIEcsm9BFe6hv4g484Nydh5ARVINo5H4BRBwCwxHmpEycAW&latitude=-1.284506&longitude=36.79291&altitude=30.25&velocity=0.01&battery=10&end=0"));
//  post_string = "";
